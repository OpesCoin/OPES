...
//---genesis blocks -------------------------------------------------------------------------------------
uint256 hashGenesisBlock("0x001f89067743c2de5c71c716766bca2e699b922bfde9df689a3e60546af2dc19");
uint256 hashGenesisBlockTestNet("0x");
//-------------------------------------------------------------------------------------------------------
uint256 MainHashMerkleRoot("0x24663ec3bc806b6c0a386ddd034bef06c069cda5149eeede6adcf4138ed7b089");
//--time blocks ---------------------------------------
static const unsigned int timeGenesisBlock =1450787395;
static const unsigned int timeGenesisBlockTestNet =1450787395;
//-------nNonce -------------------------------------
static const unsigned int nNonceGenesis=1014;
static const unsigned int nNonceGenesisTestNet=0;
//----------------------------------------------------
...
const string strMessageMagic = "OPES Signed Message:\n";
...
static const int64 nPremine = 520000 * COIN;
...
int64 static GetBlockSubsidy(int nHeight){
	...
	if(nHeight > 1 && nHeight < 101) 
	{        
        nSubsidy = 2 * COIN;	// Anti instamine, 2 OPES
	}
...
static const int64 nTargetSpacing = 1 * 60; // OPES every 60 seconds
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        // Prevent blocks from too far in the future [since OPES version 2.0 at block 100,000]
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "22-12-2015 OPES coin launched";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xf3, 0xf1, 0xd2, 0xb5 };
