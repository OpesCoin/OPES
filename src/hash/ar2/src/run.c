...
static void usage(const char *cmd) {
    ...
    printf("\t-d\t\tUse OPESd instead of Argon2i (which is the default)\n");
...
/*
Runs OPES with certain inputs and parameters, inputs not cleared. Prints the
