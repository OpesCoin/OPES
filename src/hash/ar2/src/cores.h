...
/*
 * OPES instance: memory pointer, number of passes, amount of memory, type,
 * and derived values.
...
/*
 * OPES position: where we construct the block right now. Used to distribute
 ...
 * @param  context  Pointer to the OPES internal structure containing memory
 ...
 * @param  context  Pointer to the OPES internal structure containing memory
 * pointer, and parameters for time and space requirements.
 * @param  instance Current OPES instance
 ...
 * the memory.
 * @param context Pointer to current OPES context (use only the out parameters
 * from it)
 * @param instance Pointer to current instance of OPES
 ...
 * @param  context  Pointer to the OPES internal structure
