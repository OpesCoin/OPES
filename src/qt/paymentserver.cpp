...
const QString BITCOIN_IPC_PREFIX("OPES:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click OPES: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start OPES: click-to-pay handler");
    else
...
{
    // clicking on OPES: URLs creates FileOpen events on the Mac:
